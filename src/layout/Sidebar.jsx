...
function Sidebar({ sidebarOpen, setSidebarOpen, usersDataReducer }) {
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink className="flex items-center justify-center gap-3" to="/">
          ...
          <p className="text-2xl text-white font-semibold">Optimit</p>
        </NavLink>
        ...
        <nav className="py-4 px-4 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/employee" || pathname.includes("employee")}
              >
                {(handleClick, open) => {
                  return (
                    <>
                      ...
                      <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          {
                            usersDataReducer?.addUser || usersDataReducer?.editUser || usersDataReducer?.deleteUser || usersDataReducer?.viewUser
                              ? (
                                <li>
                                  <NavLink
                                    to={`/employee?page=1&size=${pageSize}`}
                                    onClick={() => {
                          ...
                          {
                            usersDataReducer?.viewWorkType || usersDataReducer?.addWorkType || usersDataReducer?.editWorkType || usersDataReducer?.deleteWorkType
                              ? (
                                <li>
                                  <NavLink
                          ...
                          {
                            usersDataReducer?.viewAchievement || usersDataReducer?.editAchievement || usersDataReducer?.addAchievement || usersDataReducer?.deleteAchievement
                              ? (
                                <li>
                                  <NavLink
                                  ...
                                  >
                                    Hodim erishgan yutuqlari
                                  </NavLink>
                                </li>
                              ) : ""
                          }
                          {
                            usersDataReducer?.viewWorkExperience || usersDataReducer?.editWorkExperience || usersDataReducer?.addWorkExperience || usersDataReducer?.deleteWorkExperience
                              ? (
                                <li>
                                  <NavLink
                          ...
                          {
                            usersDataReducer?.addRole || usersDataReducer?.deleteRole || usersDataReducer?.editRole || usersDataReducer?.viewRole
                              ? (
                                <li>
                                  <NavLink
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/students" || pathname.includes("students")}
              >
                {(handleClick, open) => {
                  return (
                    <>
                      ...
                      <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          {
                            usersDataReducer?.addStudent || usersDataReducer?.editStudent || usersDataReducer?.viewStudent || usersDataReducer?.deleteStudent
                              ? (
                                <li>
                                  <NavLink
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/salaries" || pathname.includes("salaries")}
              >
                {(handleClick, open) => {
                  return (
                    <>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/salaries" || pathname.includes("salaries"))
                          && "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/journal" || pathname.includes("journal")}
              >
                {(handleClick, open) => {
                  return (
                    <>
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/kitchen" || pathname.includes("kitchen")}
              >
                {(handleClick, open) => {
                  return (
                    <>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/kitchen" || pathname.includes("kitchen"))
                          && "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
...
export default connect((usersDataReducer), {})(Sidebar);
