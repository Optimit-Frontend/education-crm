    ...
    <div>
      ...
      <div className="flex items-center justify-between gap-5 mb-3">
        ...
        <div className="flex items-center gap-5">
          {selectedRowKeys[0].length === 1 && usersDataReducer?.editWorkExperience && (
            <button
              onClick={() => {
                setOnedit(true);
                setVisible(true);
          ...
          {
            usersDataReducer?.addWorkExperience
              ? (
                <button
                  onClick={() => {
                    setVisible(true);
          ...
          {
            usersDataReducer?.deleteWorkExperience
              ? (
                <button
                  onClick={() => {
