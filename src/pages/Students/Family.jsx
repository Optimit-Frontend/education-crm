  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-end gap-5 mb-3">
        {selectedRowKeys[0].length === 1 && usersDataReducer?.editFamily && (
          <button
            onClick={() => {
              setOnedit(true);
              setVisible(true);
        ...
        <Form form={form} layout="vertical" name="table_adddata_modal">
          <Row gutter={24}>
            <Col span={12}>
              ...
              >
                <InputNumber addonBefore="+998" className="w-full" placeholder="Tel raqam" />
              </Form.Item>
              <Form.Item
                key="password"
                name="password"
