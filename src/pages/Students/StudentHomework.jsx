...
import employeeReducer, { getEmployeeBranch } from "../../reducer/employeeReducer.js";
...
function StudentHomework({
  usersDataReducer,
  getAllBalanceBranch,
  getStudentsAll, getEmployeeBranch, employeeReducer,
  studentReducer, subjectReducer, classReducer, getSubject, getClassesAll,
...
export default connect(
  (
    usersDataReducer, studentReducer, employeeReducer,
    balanceReducer, studentHomeworkReducer, subjectReducer, classReducer
  ), {
    getAllBalanceBranch,
    getStudentsAll,
    getSubject,
