...
export default connect((usersDataReducer, studentReducer), { getStudentsAll, getStudentById, getStudentsAllNeActive, getStudentsAllByClass, deleteStudent, editStudent, saveStudent })(BusinessesData);
